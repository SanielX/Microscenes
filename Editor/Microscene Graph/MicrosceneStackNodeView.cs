...
{
    internal class MicrosceneStackNodeView : StackNode, IConnectable
    {
        ...
        public MicrosceneStackNodeView(MicrosceneStackBehaviour stackBehaviour, GraphView view) : base()
        {
